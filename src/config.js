 ...
 *   'grip'    → upright ready grip, fixed to the animated wrist
...
export const WEAPONS = [
  {
    ...
    hand: 'right',
    // This asset is authored with the blade pointing down; flip before placing the grip.
    flipAxis: true,
    align: 'grip',
    twoHanded: true,
    length: 1.15,
  ...
  },
  {
    ...
    excludeNodes: ['arrow', 'arrow001', 'arrow.001'],
    hand: 'left',
    align: 'upright',
    length: 1.3,
    grip: 0.5,
